...
-(void)drawRect:(CGRect)rect
{
    ...
    CTParagraphStyleRef style = CTParagraphStyleCreate(settings, 15);
...
//    [attributedString1 addAttribute:NSParagraphStyleAttributeName value:sty range:NSMakeRange(0, str.length)];
//    attributedContent addAttribute:attributedString1 value:<#(nonnull id)#> range:<#(NSRange)#> attributedString1;
